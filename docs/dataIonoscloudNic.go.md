...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionoscloudnic"
...
&dataionoscloudnic.DataIonoscloudNicConfig {
	...
	Lan: *f64,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudNic.DataIonoscloudNicTimeouts,
}
```
