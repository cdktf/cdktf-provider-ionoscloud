...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/group"
...
&group.GroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.group.GroupTimeouts,
	UserId: *string,
	UserIds: *[]*string,
}
```
