...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/group"
...
&group.GroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.group.GroupTimeouts,
	UserId: *string,
	UserIds: *[]*string,
}
```
