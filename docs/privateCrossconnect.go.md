...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/privatecrossconnect"
...
&privatecrossconnect.PrivateCrossconnectConfig {
	...
	Id: *string,
	Peers: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.privateCrossconnect.PrivateCrossconnectTimeouts,
}
```
