...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/privatecrossconnect"
...
&privatecrossconnect.PrivateCrossconnectConfig {
	...
	Id: *string,
	Peers: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.privateCrossconnect.PrivateCrossconnectTimeouts,
}
```
