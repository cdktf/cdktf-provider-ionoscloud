...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/dnszone"
...
&dnszone.DnsZoneConfig {
	...
	Enabled: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud.dnsZone.DnsZoneTimeouts,
}
```
