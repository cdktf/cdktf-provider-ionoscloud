...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/autocertificate"
...
&autocertificate.AutoCertificateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.autoCertificate.AutoCertificateTimeouts,
}
```
