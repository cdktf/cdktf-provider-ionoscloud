...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/applicationloadbalancer"
...
&applicationloadbalancer.ApplicationLoadbalancerConfig {
	...
	Ips: *[]*string,
	LbPrivateIps: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.applicationLoadbalancer.ApplicationLoadbalancerTimeouts,
}
```
