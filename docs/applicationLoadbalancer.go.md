...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6/applicationloadbalancer"
...
| <code><a href="#@cdktf/provider-ionoscloud.applicationLoadbalancer.ApplicationLoadbalancer.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&applicationloadbalancer.ApplicationLoadbalancerConfig {
	...
	Ips: *[]*string,
	LbPrivateIps: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6.applicationLoadbalancer.ApplicationLoadbalancerTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-ionoscloud.applicationLoadbalancer.ApplicationLoadbalancerConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
