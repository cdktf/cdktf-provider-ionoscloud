...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/applicationloadbalancer"
...
&applicationloadbalancer.ApplicationLoadbalancerConfig {
	...
	Ips: *[]*string,
	LbPrivateIps: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.applicationLoadbalancer.ApplicationLoadbalancerTimeouts,
}
```
