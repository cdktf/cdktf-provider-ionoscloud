...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/dataionoscloudcdndistribution"
...
&dataionoscloudcdndistribution.DataIonoscloudCdnDistributionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.dataIonoscloudCdnDistribution.DataIonoscloudCdnDistributionTimeouts,
}
```
