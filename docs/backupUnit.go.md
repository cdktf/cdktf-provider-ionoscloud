...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/backupunit"
...
&backupunit.BackupUnitConfig {
	...
	Password: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.backupUnit.BackupUnitTimeouts,
}
```
