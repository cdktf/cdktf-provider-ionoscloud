...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/backupunit"
...
&backupunit.BackupUnitConfig {
	...
	Password: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.backupUnit.BackupUnitTimeouts,
}
```
