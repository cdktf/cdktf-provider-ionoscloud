...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/dataionoscloudnatgatewayrule"
...
&dataionoscloudnatgatewayrule.DataIonoscloudNatgatewayRuleConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.dataIonoscloudNatgatewayRule.DataIonoscloudNatgatewayRuleTimeouts,
}
```
