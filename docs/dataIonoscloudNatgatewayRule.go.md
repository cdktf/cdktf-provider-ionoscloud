...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudnatgatewayrule"
...
&dataionoscloudnatgatewayrule.DataIonoscloudNatgatewayRuleConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudNatgatewayRule.DataIonoscloudNatgatewayRuleTimeouts,
}
```
