...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6/applicationloadbalancerforwardingrule"
...
&applicationloadbalancerforwardingrule.ApplicationLoadbalancerForwardingruleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6.applicationLoadbalancerForwardingrule.ApplicationLoadbalancerForwardingruleTimeouts,
}
```
