...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/applicationloadbalancerforwardingrule"
...
&applicationloadbalancerforwardingrule.ApplicationLoadbalancerForwardingruleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.applicationLoadbalancerForwardingrule.ApplicationLoadbalancerForwardingruleTimeouts,
}
```
