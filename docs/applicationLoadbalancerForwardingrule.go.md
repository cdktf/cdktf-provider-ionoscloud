...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/applicationloadbalancerforwardingrule"
...
&applicationloadbalancerforwardingrule.ApplicationLoadbalancerForwardingruleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.applicationLoadbalancerForwardingrule.ApplicationLoadbalancerForwardingruleTimeouts,
}
```
