...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionoscloudipfailover"
...
&dataionoscloudipfailover.DataIonoscloudIpfailoverConfig {
	...
	LanId: *string,
	Nicuuid: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudIpfailover.DataIonoscloudIpfailoverTimeouts,
}
```
