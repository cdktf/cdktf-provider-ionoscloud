...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudipfailover"
...
&dataionoscloudipfailover.DataIonoscloudIpfailoverConfig {
	...
	LanId: *string,
	Nicuuid: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudIpfailover.DataIonoscloudIpfailoverTimeouts,
}
```
