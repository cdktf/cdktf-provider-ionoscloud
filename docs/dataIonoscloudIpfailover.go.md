...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/dataionoscloudipfailover"
...
&dataionoscloudipfailover.DataIonoscloudIpfailoverConfig {
	...
	LanId: *string,
	Nicuuid: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.dataIonoscloudIpfailover.DataIonoscloudIpfailoverTimeouts,
}
```
