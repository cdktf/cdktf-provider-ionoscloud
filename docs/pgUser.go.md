...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/pguser"
...
&pguser.PgUserConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.pgUser.PgUserTimeouts,
}
```
