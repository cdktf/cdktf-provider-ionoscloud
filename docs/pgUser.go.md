...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/pguser"
...
&pguser.PgUserConfig {
	...
	Username: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.pgUser.PgUserTimeouts,
}
```
