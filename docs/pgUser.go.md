...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/pguser"
...
| <code><a href="#@cdktf/provider-ionoscloud.pgUser.PgUser.property.isSystemUserInput">IsSystemUserInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-ionoscloud.pgUser.PgUser.property.isSystemUser">IsSystemUser</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func IsSystemUserInput() interface{}
```
...
&pguser.PgUserConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.pgUser.PgUserTimeouts,
}
```
