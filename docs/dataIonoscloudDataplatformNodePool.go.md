...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionosclouddataplatformnodepool"
...
&dataionosclouddataplatformnodepool.DataIonoscloudDataplatformNodePoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudDataplatformNodePool.DataIonoscloudDataplatformNodePoolTimeouts,
}
```
