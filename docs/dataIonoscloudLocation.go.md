...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudlocation"
...
&dataionoscloudlocation.DataIonoscloudLocationConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudLocation.DataIonoscloudLocationTimeouts,
}
```
