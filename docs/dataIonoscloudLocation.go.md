...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionoscloudlocation"
...
&dataionoscloudlocation.DataIonoscloudLocationConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudLocation.DataIonoscloudLocationTimeouts,
}
```
