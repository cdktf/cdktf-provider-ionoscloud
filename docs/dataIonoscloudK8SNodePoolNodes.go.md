...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/dataionoscloudk8snodepoolnodes"
...
&dataionoscloudk8snodepoolnodes.DataIonoscloudK8SNodePoolNodesConfig {
	...
	NodePoolId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.dataIonoscloudK8SNodePoolNodes.DataIonoscloudK8SNodePoolNodesTimeouts,
}
```
