...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/dataionosclouddnsrecord"
...
&dataionosclouddnsrecord.DataIonoscloudDnsRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.dataIonoscloudDnsRecord.DataIonoscloudDnsRecordTimeouts,
}
```
