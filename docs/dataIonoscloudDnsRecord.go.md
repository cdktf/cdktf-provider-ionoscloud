...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionosclouddnsrecord"
...
&dataionosclouddnsrecord.DataIonoscloudDnsRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudDnsRecord.DataIonoscloudDnsRecordTimeouts,
}
```
