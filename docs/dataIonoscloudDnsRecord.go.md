...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/dataionosclouddnsrecord"
...
&dataionosclouddnsrecord.DataIonoscloudDnsRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.dataIonoscloudDnsRecord.DataIonoscloudDnsRecordTimeouts,
}
```
