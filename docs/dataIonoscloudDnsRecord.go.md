...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionosclouddnsrecord"
...
&dataionosclouddnsrecord.DataIonoscloudDnsRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudDnsRecord.DataIonoscloudDnsRecordTimeouts,
}
```
