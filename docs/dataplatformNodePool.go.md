...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/dataplatformnodepool"
...
&dataplatformnodepool.DataplatformNodePoolConfig {
	...
	StorageSize: *f64,
	StorageType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.dataplatformNodePool.DataplatformNodePoolTimeouts,
}
```
