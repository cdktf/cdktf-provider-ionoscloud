...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataplatformnodepool"
...
&dataplatformnodepool.DataplatformNodePoolConfig {
	...
	StorageSize: *f64,
	StorageType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataplatformNodePool.DataplatformNodePoolTimeouts,
}
```
