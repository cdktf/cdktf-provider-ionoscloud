...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/dataplatformnodepool"
...
&dataplatformnodepool.DataplatformNodePoolConfig {
	...
	StorageSize: *f64,
	StorageType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.dataplatformNodePool.DataplatformNodePoolTimeouts,
}
```
