...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/dataionoscloudvcpuserver"
...
&dataionoscloudvcpuserver.DataIonoscloudVcpuServerConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.dataIonoscloudVcpuServer.DataIonoscloudVcpuServerTimeouts,
}
```
