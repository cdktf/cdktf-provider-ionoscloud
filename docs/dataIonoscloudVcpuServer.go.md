...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudvcpuserver"
...
&dataionoscloudvcpuserver.DataIonoscloudVcpuServerConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudVcpuServer.DataIonoscloudVcpuServerTimeouts,
}
```
