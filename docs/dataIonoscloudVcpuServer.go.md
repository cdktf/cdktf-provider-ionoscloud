...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v11/dataionoscloudvcpuserver"
...
&dataionoscloudvcpuserver.DataIonoscloudVcpuServerConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v11.dataIonoscloudVcpuServer.DataIonoscloudVcpuServerTimeouts,
}
```
