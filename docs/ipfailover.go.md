...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/ipfailover"
...
&ipfailover.IpfailoverConfig {
	...
	Nicuuid: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.ipfailover.IpfailoverTimeouts,
}
```
