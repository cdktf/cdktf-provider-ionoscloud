...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/s3key"
...
| <code><a href="#@cdktf/provider-ionoscloud.s3Key.S3Key.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&s3key.S3KeyConfig {
	...
	Active: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.s3Key.S3KeyTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-ionoscloud.s3Key.S3KeyConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
