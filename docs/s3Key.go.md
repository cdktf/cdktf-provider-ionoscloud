...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/s3key"
...
&s3key.S3KeyConfig {
	...
	Active: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.s3Key.S3KeyTimeouts,
}
```
