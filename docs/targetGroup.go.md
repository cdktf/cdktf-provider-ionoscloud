...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6/targetgroup"
...
&targetgroup.TargetGroupConfig {
	...
	Protocol: *string,
	Targets: interface{},
	HealthCheck: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6.targetGroup.TargetGroupHealthCheck,
	HttpHealthCheck: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6.targetGroup.TargetGroupHttpHealthCheck,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6.targetGroup.TargetGroupTimeouts,
}
```
