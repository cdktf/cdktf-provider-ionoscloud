...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/firewall"
...
&firewall.FirewallConfig {
	...
	SourceMac: *string,
	TargetIp: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.firewall.FirewallTimeouts,
	Type: *string,
}
```
