...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/dataionoscloudimage"
...
| <code><a href="#@cdktf/provider-ionoscloud.dataIonoscloudImage.DataIonoscloudImage.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataionoscloudimage.DataIonoscloudImageConfig {
	...
	Location: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.dataIonoscloudImage.DataIonoscloudImageTimeouts,
	Type: *string,
	Version: *string,
}
```
...
| <code><a href="#@cdktf/provider-ionoscloud.dataIonoscloudImage.DataIonoscloudImageConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
