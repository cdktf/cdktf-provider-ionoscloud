...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionoscloudimage"
...
&dataionoscloudimage.DataIonoscloudImageConfig {
	...
	Location: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudImage.DataIonoscloudImageTimeouts,
	Type: *string,
	Version: *string,
}
```
