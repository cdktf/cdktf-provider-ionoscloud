...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/loggingpipeline"
...
&loggingpipeline.LoggingPipelineConfig {
	...
	Id: *string,
	Location: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.loggingPipeline.LoggingPipelineTimeouts,
}
```
