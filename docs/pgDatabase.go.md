...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/pgdatabase"
...
&pgdatabase.PgDatabaseConfig {
	...
	Owner: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.pgDatabase.PgDatabaseTimeouts,
}
```
