...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/pgdatabase"
...
&pgdatabase.PgDatabaseConfig {
	...
	Owner: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.pgDatabase.PgDatabaseTimeouts,
}
```
