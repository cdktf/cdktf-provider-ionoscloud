...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/dataionoscloudtargetgroup"
...
&dataionoscloudtargetgroup.DataIonoscloudTargetGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.dataIonoscloudTargetGroup.DataIonoscloudTargetGroupTimeouts,
}
```
