...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/dataionoscloudpgcluster"
...
&dataionoscloudpgcluster.DataIonoscloudPgClusterConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.dataIonoscloudPgCluster.DataIonoscloudPgClusterTimeouts,
}
```
