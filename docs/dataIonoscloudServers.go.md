...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionoscloudservers"
...
&dataionoscloudservers.DataIonoscloudServersConfig {
	...
	Filter: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudServers.DataIonoscloudServersTimeouts,
}
```
