...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/dataionoscloudnsg"
...
&dataionoscloudnsg.DataIonoscloudNsgConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.dataIonoscloudNsg.DataIonoscloudNsgTimeouts,
}
```
