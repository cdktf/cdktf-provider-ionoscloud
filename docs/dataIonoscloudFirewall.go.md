...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudfirewall"
...
&dataionoscloudfirewall.DataIonoscloudFirewallConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudFirewall.DataIonoscloudFirewallTimeouts,
}
```
