...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6/dataionoscloudserver"
...
&dataionoscloudserver.DataIonoscloudServerConfig {
	...
	Name: *string,
	TemplateUuid: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6.dataIonoscloudServer.DataIonoscloudServerTimeouts,
	Type: *string,
}
```
