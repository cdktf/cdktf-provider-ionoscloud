...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudserver"
...
&dataionoscloudserver.DataIonoscloudServerConfig {
	...
	Name: *string,
	TemplateUuid: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudServer.DataIonoscloudServerTimeouts,
	Type: *string,
}
```
