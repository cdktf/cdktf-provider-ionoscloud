...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudsnapshot"
...
&dataionoscloudsnapshot.DataIonoscloudSnapshotConfig {
	...
	Name: *string,
	Size: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudSnapshot.DataIonoscloudSnapshotTimeouts,
}
```
