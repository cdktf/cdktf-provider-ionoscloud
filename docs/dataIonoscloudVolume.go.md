...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudvolume"
...
&dataionoscloudvolume.DataIonoscloudVolumeConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudVolume.DataIonoscloudVolumeTimeouts,
}
```
