...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionoscloudvolume"
...
&dataionoscloudvolume.DataIonoscloudVolumeConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudVolume.DataIonoscloudVolumeTimeouts,
}
```
