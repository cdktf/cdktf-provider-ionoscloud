...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/cdndistribution"
...
&cdndistribution.CdnDistributionConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.cdnDistribution.CdnDistributionTimeouts,
}
```
...
&cdndistribution.CdnDistributionRoutingRules {
	Prefix: *string,
	Scheme: *string,
	Upstream: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.cdnDistribution.CdnDistributionRoutingRulesUpstream,
}
```
...
&cdndistribution.CdnDistributionRoutingRulesUpstream {
	...
	SniMode: *string,
	Waf: interface{},
	GeoRestrictions: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.cdnDistribution.CdnDistributionRoutingRulesUpstreamGeoRestrictions,
}
```
