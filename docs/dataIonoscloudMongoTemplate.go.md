...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionoscloudmongotemplate"
...
&dataionoscloudmongotemplate.DataIonoscloudMongoTemplateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudMongoTemplate.DataIonoscloudMongoTemplateTimeouts,
}
```
