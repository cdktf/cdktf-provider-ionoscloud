...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v11/dataionoscloudmongotemplate"
...
&dataionoscloudmongotemplate.DataIonoscloudMongoTemplateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v11.dataIonoscloudMongoTemplate.DataIonoscloudMongoTemplateTimeouts,
}
```
