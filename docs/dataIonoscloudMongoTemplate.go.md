...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/dataionoscloudmongotemplate"
...
&dataionoscloudmongotemplate.DataIonoscloudMongoTemplateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.dataIonoscloudMongoTemplate.DataIonoscloudMongoTemplateTimeouts,
}
```
