...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/dataionoscloudpgbackups"
...
&dataionoscloudpgbackups.DataIonoscloudPgBackupsConfig {
	...
	ClusterId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.dataIonoscloudPgBackups.DataIonoscloudPgBackupsTimeouts,
}
```
