...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/dataionoscloudprivatecrossconnect"
...
&dataionoscloudprivatecrossconnect.DataIonoscloudPrivateCrossconnectConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.dataIonoscloudPrivateCrossconnect.DataIonoscloudPrivateCrossconnectTimeouts,
}
```
