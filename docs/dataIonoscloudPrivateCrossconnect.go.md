...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudprivatecrossconnect"
...
&dataionoscloudprivatecrossconnect.DataIonoscloudPrivateCrossconnectConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudPrivateCrossconnect.DataIonoscloudPrivateCrossconnectTimeouts,
}
```
