...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/snapshot"
...
&snapshot.SnapshotConfig {
	...
	VolumeId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.snapshot.SnapshotTimeouts,
}
```
