...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/snapshot"
...
&snapshot.SnapshotConfig {
	...
	VolumeId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.snapshot.SnapshotTimeouts,
}
```
