...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/dataionoscloudgroup"
...
| <code><a href="#@cdktf/provider-ionoscloud.dataIonoscloudGroup.DataIonoscloudGroup.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataionoscloudgroup.DataIonoscloudGroupConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.dataIonoscloudGroup.DataIonoscloudGroupTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-ionoscloud.dataIonoscloudGroup.DataIonoscloudGroupConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
