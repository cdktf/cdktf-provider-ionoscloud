...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudgroup"
...
&dataionoscloudgroup.DataIonoscloudGroupConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudGroup.DataIonoscloudGroupTimeouts,
}
```
