...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6/mongouser"
...
&mongouser.MongoUserConfig {
	...
	Id: *string,
	Roles: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6.mongoUser.MongoUserTimeouts,
}
```
