...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/mongouser"
...
&mongouser.MongoUserConfig {
	...
	Id: *string,
	Roles: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.mongoUser.MongoUserTimeouts,
}
```
