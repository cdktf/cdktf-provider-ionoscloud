...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/dataionoscloudnetworkloadbalancer"
...
&dataionoscloudnetworkloadbalancer.DataIonoscloudNetworkloadbalancerConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.dataIonoscloudNetworkloadbalancer.DataIonoscloudNetworkloadbalancerTimeouts,
}
```
