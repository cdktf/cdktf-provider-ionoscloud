...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/natgatewayrule"
...
&natgatewayrule.NatgatewayRuleConfig {
	...
	Id: *string,
	Protocol: *string,
	TargetPortRange: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.natgatewayRule.NatgatewayRuleTargetPortRange,
	TargetSubnet: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.natgatewayRule.NatgatewayRuleTimeouts,
	Type: *string,
}
```
