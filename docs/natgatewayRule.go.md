...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/natgatewayrule"
...
&natgatewayrule.NatgatewayRuleConfig {
	...
	Id: *string,
	Protocol: *string,
	TargetPortRange: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.natgatewayRule.NatgatewayRuleTargetPortRange,
	TargetSubnet: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.natgatewayRule.NatgatewayRuleTimeouts,
	Type: *string,
}
```
