...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/natgatewayrule"
...
&natgatewayrule.NatgatewayRuleConfig {
	...
	Id: *string,
	Protocol: *string,
	TargetPortRange: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.natgatewayRule.NatgatewayRuleTargetPortRange,
	TargetSubnet: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.natgatewayRule.NatgatewayRuleTimeouts,
	Type: *string,
}
```
