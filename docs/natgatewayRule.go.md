...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/natgatewayrule"
...
&natgatewayrule.NatgatewayRuleConfig {
	...
	Id: *string,
	Protocol: *string,
	TargetPortRange: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.natgatewayRule.NatgatewayRuleTargetPortRange,
	TargetSubnet: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.natgatewayRule.NatgatewayRuleTimeouts,
	Type: *string,
}
```
