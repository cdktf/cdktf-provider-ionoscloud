...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataplatformcluster"
...
&dataplatformcluster.DataplatformClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataplatformCluster.DataplatformClusterTimeouts,
	Version: *string,
}
```
