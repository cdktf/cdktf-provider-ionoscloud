...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/server"
...
&server.ServerConfig {
	...
	DatacenterId: *string,
	Name: *string,
	Volume: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.server.ServerVolume,
	...
	Label: interface{},
	Nic: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.server.ServerNic,
	Ram: *f64,
	SshKeyPath: *[]*string,
	SshKeys: *[]*string,
	TemplateUuid: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.server.ServerTimeouts,
	Type: *string,
}
```
