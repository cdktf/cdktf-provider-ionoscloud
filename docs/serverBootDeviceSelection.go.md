...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v10/serverbootdeviceselection"
...
&serverbootdeviceselection.ServerBootDeviceSelectionConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v10.serverBootDeviceSelection.ServerBootDeviceSelectionTimeouts,
}
```
