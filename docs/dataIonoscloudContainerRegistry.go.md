...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudcontainerregistry"
...
&dataionoscloudcontainerregistry.DataIonoscloudContainerRegistryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudContainerRegistry.DataIonoscloudContainerRegistryTimeouts,
}
```
