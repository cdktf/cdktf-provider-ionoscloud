...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/dataionoscloudcontainerregistry"
...
&dataionoscloudcontainerregistry.DataIonoscloudContainerRegistryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.dataIonoscloudContainerRegistry.DataIonoscloudContainerRegistryTimeouts,
}
```
