...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/dataionosclouddataplatformnodepools"
...
&dataionosclouddataplatformnodepools.DataIonoscloudDataplatformNodePoolsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.dataIonoscloudDataplatformNodePools.DataIonoscloudDataplatformNodePoolsTimeouts,
}
```
