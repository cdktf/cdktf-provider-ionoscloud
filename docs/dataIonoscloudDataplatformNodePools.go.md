...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionosclouddataplatformnodepools"
...
&dataionosclouddataplatformnodepools.DataIonoscloudDataplatformNodePoolsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudDataplatformNodePools.DataIonoscloudDataplatformNodePoolsTimeouts,
}
```
