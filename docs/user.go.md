...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/user"
...
&user.UserConfig {
	...
	GroupIds: *[]*string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.user.UserTimeouts,
}
```
