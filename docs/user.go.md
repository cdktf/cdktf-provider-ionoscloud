...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/user"
...
&user.UserConfig {
	...
	GroupIds: *[]*string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.user.UserTimeouts,
}
```
