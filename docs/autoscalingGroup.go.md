...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12/autoscalinggroup"
...
&autoscalinggroup.AutoscalingGroupConfig {
	...
	MinReplicaCount: *f64,
	Name: *string,
	Policy: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.autoscalingGroup.AutoscalingGroupPolicy,
	ReplicaConfiguration: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.autoscalingGroup.AutoscalingGroupReplicaConfiguration,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.autoscalingGroup.AutoscalingGroupTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-ionoscloud.autoscalingGroup.AutoscalingGroupConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.12/docs/resources/autoscaling_group#id AutoscalingGroup#id}. |
...
&autoscalinggroup.AutoscalingGroupPolicy {
	Metric: *string,
	ScaleInAction: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.autoscalingGroup.AutoscalingGroupPolicyScaleInAction,
	ScaleInThreshold: *f64,
	ScaleOutAction: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.autoscalingGroup.AutoscalingGroupPolicyScaleOutAction,
...
&autoscalinggroup.AutoscalingGroupReplicaConfigurationNic {
	...
	FirewallType: *string,
	FlowLog: interface{},
	TargetGroup: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v12.autoscalingGroup.AutoscalingGroupReplicaConfigurationNicTargetGroup,
}
```
...
| <code><a href="#@cdktf/provider-ionoscloud.autoscalingGroup.AutoscalingGroupReplicaConfigurationVolume.property.sshKeys">SshKeys</a></code> | <code>*[]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.12/docs/resources/autoscaling_group#ssh_keys AutoscalingGroup#ssh_keys}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-ionoscloud.autoscalingGroup.AutoscalingGroupTimeouts.property.create">Create</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.12/docs/resources/autoscaling_group#create AutoscalingGroup#create}. |
| <code><a href="#@cdktf/provider-ionoscloud.autoscalingGroup.AutoscalingGroupTimeouts.property.default">Default</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.12/docs/resources/autoscaling_group#default AutoscalingGroup#default}. |
| <code><a href="#@cdktf/provider-ionoscloud.autoscalingGroup.AutoscalingGroupTimeouts.property.delete">Delete</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.12/docs/resources/autoscaling_group#delete AutoscalingGroup#delete}. |
| <code><a href="#@cdktf/provider-ionoscloud.autoscalingGroup.AutoscalingGroupTimeouts.property.update">Update</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.12/docs/resources/autoscaling_group#update AutoscalingGroup#update}. |
