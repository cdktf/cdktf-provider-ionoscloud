...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/dataionoscloudpgversions"
...
&dataionoscloudpgversions.DataIonoscloudPgVersionsConfig {
	...
	ClusterId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.dataIonoscloudPgVersions.DataIonoscloudPgVersionsTimeouts,
}
```
