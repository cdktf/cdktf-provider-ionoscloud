...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionoscloudpgversions"
...
&dataionoscloudpgversions.DataIonoscloudPgVersionsConfig {
	...
	ClusterId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudPgVersions.DataIonoscloudPgVersionsTimeouts,
}
```
