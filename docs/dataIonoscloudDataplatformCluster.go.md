...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/dataionosclouddataplatformcluster"
...
&dataionosclouddataplatformcluster.DataIonoscloudDataplatformClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.dataIonoscloudDataplatformCluster.DataIonoscloudDataplatformClusterTimeouts,
}
```
