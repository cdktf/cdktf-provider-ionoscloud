...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5/ipblock"
...
&ipblock.IpblockConfig {
	...
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v5.ipblock.IpblockTimeouts,
}
```
