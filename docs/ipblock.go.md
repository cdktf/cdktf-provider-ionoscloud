...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/ipblock"
...
&ipblock.IpblockConfig {
	...
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.ipblock.IpblockTimeouts,
}
```
