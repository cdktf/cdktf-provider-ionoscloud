...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/ipblock"
...
&ipblock.IpblockConfig {
	...
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.ipblock.IpblockTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-ionoscloud.ipblock.IpblockConfig.property.size">Size</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.8/docs/resources/ipblock#size Ipblock#size}. |
