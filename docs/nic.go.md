...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/nic"
...
&nic.NicConfig {
	...
	Ips: *[]*string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.nic.NicTimeouts,
}
```
