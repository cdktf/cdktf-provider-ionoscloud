...
new DataIonoscloudVpnIpsecGateway(Construct Scope, string Id, DataIonoscloudVpnIpsecGatewayConfig Config);
```
...
Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.2/docs/data-sources/vpn_ipsec_gateway#import import section} in the documentation of this resource for the id to use
