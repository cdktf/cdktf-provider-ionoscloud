...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/volume"
...
&volume.VolumeConfig {
	...
	SshKeyPath: *[]*string,
	SshKeys: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.volume.VolumeTimeouts,
	UserData: *string,
}
```
