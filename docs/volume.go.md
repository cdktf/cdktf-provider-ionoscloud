...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8/volume"
...
&volume.VolumeConfig {
	...
	SshKeyPath: *[]*string,
	SshKeys: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v8.volume.VolumeTimeouts,
	UserData: *string,
}
```
...
| <code><a href="#@cdktf/provider-ionoscloud.volume.VolumeConfig.property.size">Size</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.7/docs/resources/volume#size Volume#size}. |
