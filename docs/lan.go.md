...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/lan"
...
&lan.LanConfig {
	...
	Pcc: *string,
	Public: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.lan.LanTimeouts,
}
```
