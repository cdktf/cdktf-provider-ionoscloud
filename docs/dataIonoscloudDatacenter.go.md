...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionosclouddatacenter"
...
&dataionosclouddatacenter.DataIonoscloudDatacenterConfig {
	...
	Location: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudDatacenter.DataIonoscloudDatacenterTimeouts,
}
```
