...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionosclouduser"
...
&dataionosclouduser.DataIonoscloudUserConfig {
	...
	Email: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudUser.DataIonoscloudUserTimeouts,
}
```
