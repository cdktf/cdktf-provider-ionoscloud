...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionosclouduser"
...
&dataionosclouduser.DataIonoscloudUserConfig {
	...
	Email: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudUser.DataIonoscloudUserTimeouts,
}
```
