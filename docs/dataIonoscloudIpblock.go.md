...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudipblock"
...
&dataionoscloudipblock.DataIonoscloudIpblockConfig {
	...
	Name: *string,
	Size: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudIpblock.DataIonoscloudIpblockTimeouts,
}
```
