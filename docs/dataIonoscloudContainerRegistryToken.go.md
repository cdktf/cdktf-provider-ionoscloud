...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudcontainerregistrytoken"
...
&dataionoscloudcontainerregistrytoken.DataIonoscloudContainerRegistryTokenConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudContainerRegistryToken.DataIonoscloudContainerRegistryTokenTimeouts,
}
```
