...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionosclouddataplatformversions"
...
&dataionosclouddataplatformversions.DataIonoscloudDataplatformVersionsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudDataplatformVersions.DataIonoscloudDataplatformVersionsTimeouts,
}
```
