...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/dataionoscloudshare"
...
&dataionoscloudshare.DataIonoscloudShareConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.dataIonoscloudShare.DataIonoscloudShareTimeouts,
}
```
