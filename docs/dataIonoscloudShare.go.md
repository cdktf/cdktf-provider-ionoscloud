...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionoscloudshare"
...
&dataionoscloudshare.DataIonoscloudShareConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudShare.DataIonoscloudShareTimeouts,
}
```
