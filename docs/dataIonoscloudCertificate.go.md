...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionoscloudcertificate"
...
&dataionoscloudcertificate.DataIonoscloudCertificateConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudCertificate.DataIonoscloudCertificateTimeouts,
}
```
