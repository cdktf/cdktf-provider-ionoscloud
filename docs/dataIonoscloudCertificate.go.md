...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6/dataionoscloudcertificate"
...
&dataionoscloudcertificate.DataIonoscloudCertificateConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v6.dataIonoscloudCertificate.DataIonoscloudCertificateTimeouts,
}
```
