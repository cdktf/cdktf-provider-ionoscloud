...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7/dataionoscloudtemplate"
...
&dataionoscloudtemplate.DataIonoscloudTemplateConfig {
	...
	Ram: *f64,
	StorageSize: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v7.dataIonoscloudTemplate.DataIonoscloudTemplateTimeouts,
}
```
