...
```go
import "github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9/k8snodepool"
...
&k8snodepool.K8SNodePoolConfig {
	...
	AutoScaling: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.k8SNodePool.K8SNodePoolAutoScaling,
	Id: *string,
	Labels: *map[string]*string,
	Lans: interface{},
	MaintenanceWindow: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.k8SNodePool.K8SNodePoolMaintenanceWindow,
	PublicIps: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-ionoscloud-go/ionoscloud/v9.k8SNodePool.K8SNodePoolTimeouts,
}
```
