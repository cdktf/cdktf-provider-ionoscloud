...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.6.9/docs/resources/datacenter
...
export class Datacenter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Datacenter that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.6.9/docs/resources/datacenter#import import section} in the documentation of this resource for the id to use
