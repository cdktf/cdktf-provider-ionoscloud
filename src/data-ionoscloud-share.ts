// https://www.terraform.io/docs/providers/ionoscloud/d/share
...
export function dataIonoscloudShareTimeoutsToTerraform(struct?: DataIonoscloudShareTimeoutsOutputReference | DataIonoscloudShareTimeouts | cdktf.IResolvable): any {
...
export class DataIonoscloudShareTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataIonoscloudShareTimeouts | undefined {
  ...
  public set internalValue(value: DataIonoscloudShareTimeouts | undefined) {
    if (value === undefined) {
