...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.6.3/docs/resources/apigateway
...
export class Apigateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Apigateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.6.3/docs/resources/apigateway#import import section} in the documentation of this resource for the id to use
