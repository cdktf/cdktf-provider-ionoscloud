...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.10/docs/resources/networkloadbalancer
...
export class Networkloadbalancer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Networkloadbalancer that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.10/docs/resources/networkloadbalancer#import import section} in the documentation of this resource for the id to use
