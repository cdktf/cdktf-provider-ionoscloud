// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.1/docs/data-sources/autoscaling_group
...
export class DataIonoscloudAutoscalingGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIonoscloudAutoscalingGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.1/docs/data-sources/autoscaling_group#import import section} in the documentation of this resource for the id to use
