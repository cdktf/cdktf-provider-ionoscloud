...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.7/docs/data-sources/autoscaling_group_servers
...
export class DataIonoscloudAutoscalingGroupServers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIonoscloudAutoscalingGroupServers that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.7/docs/data-sources/autoscaling_group_servers#import import section} in the documentation of this resource for the id to use
