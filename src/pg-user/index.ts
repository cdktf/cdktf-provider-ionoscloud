// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.10/docs/resources/pg_user
...
export interface PgUserConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly isSystemUser?: boolean | cdktf.IResolvable;
  /**
...
export class PgUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PgUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.10/docs/resources/pg_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: PgUserConfig) {
    ...
    this._id = config.id;
    this._isSystemUser = config.isSystemUser;
  ...
  // is_system_user - computed: true, optional: true, required: false
  private _isSystemUser?: boolean | cdktf.IResolvable; 
  public get isSystemUser() {
    return this.getBooleanAttribute('is_system_user');
  }
  public set isSystemUser(value: boolean | cdktf.IResolvable) {
    this._isSystemUser = value;
  }
  public resetIsSystemUser() {
    this._isSystemUser = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get isSystemUserInput() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      is_system_user: cdktf.booleanToTerraform(this._isSystemUser),
