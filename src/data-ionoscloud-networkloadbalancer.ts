...
export class DataIonoscloudNetworkloadbalancerTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataIonoscloudNetworkloadbalancerTimeouts | undefined {
  ...
  public set internalValue(value: DataIonoscloudNetworkloadbalancerTimeouts | undefined) {
    if (value === undefined) {
