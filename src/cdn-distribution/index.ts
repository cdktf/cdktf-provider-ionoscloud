// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.4/docs/resources/cdn_distribution
...
export class CdnDistribution extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnDistribution that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.4/docs/resources/cdn_distribution#import import section} in the documentation of this resource for the id to use
