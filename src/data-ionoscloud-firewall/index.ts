// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.6.3/docs/data-sources/firewall
...
export class DataIonoscloudFirewall extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIonoscloudFirewall that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.6.3/docs/data-sources/firewall#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.6.3/docs/data-sources/firewall ionoscloud_firewall} Data Source
  *
  * @param scope The scope in which to define this construct
