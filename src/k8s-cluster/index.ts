...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.10/docs/resources/k8s_cluster
...
export class K8SCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing K8SCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.10/docs/resources/k8s_cluster#import import section} in the documentation of this resource for the id to use
