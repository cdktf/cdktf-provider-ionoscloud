...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.6.0/docs/resources/vpn_ipsec_tunnel
...
export class VpnIpsecTunnel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnIpsecTunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.6.0/docs/resources/vpn_ipsec_tunnel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.6.0/docs/resources/vpn_ipsec_tunnel ionoscloud_vpn_ipsec_tunnel} Resource
  *
  * @param scope The scope in which to define this construct
