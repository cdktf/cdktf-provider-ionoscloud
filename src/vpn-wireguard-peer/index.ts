// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.4/docs/resources/vpn_wireguard_peer
...
export class VpnWireguardPeer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnWireguardPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.4/docs/resources/vpn_wireguard_peer#import import section} in the documentation of this resource for the id to use
