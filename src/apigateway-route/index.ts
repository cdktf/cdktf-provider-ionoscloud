// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.1/docs/resources/apigateway_route
...
export class ApigatewayRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigatewayRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.1/docs/resources/apigateway_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.1/docs/resources/apigateway_route ionoscloud_apigateway_route} Resource
  *
  * @param scope The scope in which to define this construct
