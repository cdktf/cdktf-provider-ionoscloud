// https://www.terraform.io/docs/providers/ionoscloud/d/lan
...
export function dataIonoscloudLanTimeoutsToTerraform(struct?: DataIonoscloudLanTimeoutsOutputReference | DataIonoscloudLanTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataIonoscloudLanTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataIonoscloudLanTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataIonoscloudLanTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
