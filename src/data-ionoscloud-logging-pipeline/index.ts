// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.8/docs/data-sources/logging_pipeline
...
export interface DataIonoscloudLoggingPipelineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.8/docs/data-sources/logging_pipeline#id DataIonoscloudLoggingPipeline#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.8/docs/data-sources/logging_pipeline#location DataIonoscloudLoggingPipeline#location}
  */
  readonly location?: string;
  /**
  * The name of the Logging pipeline
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.8/docs/data-sources/logging_pipeline#name DataIonoscloudLoggingPipeline#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.8/docs/data-sources/logging_pipeline ionoscloud_logging_pipeline}
*/
export class DataIonoscloudLoggingPipeline extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIonoscloudLoggingPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.8/docs/data-sources/logging_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.8/docs/data-sources/logging_pipeline ionoscloud_logging_pipeline} Data Source
  *
  * @param scope The scope in which to define this construct
