...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.4/docs/resources/vpn_ipsec_gateway
...
export class VpnIpsecGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnIpsecGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.4/docs/resources/vpn_ipsec_gateway#import import section} in the documentation of this resource for the id to use
