...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.10/docs/resources/natgateway
...
export class Natgateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Natgateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.10/docs/resources/natgateway#import import section} in the documentation of this resource for the id to use
