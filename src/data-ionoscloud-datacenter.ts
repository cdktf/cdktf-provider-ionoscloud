...
export class DataIonoscloudDatacenterTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataIonoscloudDatacenterTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataIonoscloudDatacenterTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
