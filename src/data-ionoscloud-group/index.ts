...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.9/docs/data-sources/group
...
export class DataIonoscloudGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIonoscloudGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.9/docs/data-sources/group#import import section} in the documentation of this resource for the id to use
