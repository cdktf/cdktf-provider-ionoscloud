...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic
...
export interface KafkaClusterTopicConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#cluster_id KafkaClusterTopic#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The location of your Kafka Cluster Topic. Supported locations: de/fra, de/txl
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#location KafkaClusterTopic#location}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#name KafkaClusterTopic#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#number_of_partitions KafkaClusterTopic#number_of_partitions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#replication_factor KafkaClusterTopic#replication_factor}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#retention_time KafkaClusterTopic#retention_time}
  */
  readonly retentionTime?: number;
  /**
  * This configuration controls the segment file size for the log. Retention and cleaning is always done a file at a time so a larger segment size means fewer files but less granular control over retention.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#segment_bytes KafkaClusterTopic#segment_bytes}
  */
  readonly segmentBytes?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#timeouts KafkaClusterTopic#timeouts}
  */
  readonly timeouts?: KafkaClusterTopicTimeouts;
}
export interface KafkaClusterTopicTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#create KafkaClusterTopic#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#default KafkaClusterTopic#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#delete KafkaClusterTopic#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#update KafkaClusterTopic#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic ionoscloud_kafka_cluster_topic}
*/
export class KafkaClusterTopic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KafkaClusterTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.9/docs/resources/kafka_cluster_topic ionoscloud_kafka_cluster_topic} Resource
  *
  * @param scope The scope in which to define this construct
