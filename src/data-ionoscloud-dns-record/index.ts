...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.14/docs/data-sources/dns_record
...
export class DataIonoscloudDnsRecord extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIonoscloudDnsRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.14/docs/data-sources/dns_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.14/docs/data-sources/dns_record ionoscloud_dns_record} Data Source
  *
  * @param scope The scope in which to define this construct
