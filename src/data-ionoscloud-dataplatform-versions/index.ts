...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.12/docs/data-sources/dataplatform_versions
...
export function dataIonoscloudDataplatformVersionsTimeoutsToTerraform(struct?: DataIonoscloudDataplatformVersionsTimeouts | cdktf.IResolvable): any {
...
export function dataIonoscloudDataplatformVersionsTimeoutsToHclTerraform(struct?: DataIonoscloudDataplatformVersionsTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataIonoscloudDataplatformVersionsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataIonoscloudDataplatformVersionsTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataIonoscloudDataplatformVersionsTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataIonoscloudDataplatformVersions extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "ionoscloud_dataplatform_versions";
  ...
  * @param importFromId The id of the existing DataIonoscloudDataplatformVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.4.12/docs/data-sources/dataplatform_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "ionoscloud_dataplatform_versions", importId: importFromId, provider });
      }
  ...
  * @param options DataIonoscloudDataplatformVersionsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataIonoscloudDataplatformVersionsConfig = {}) {
    super(scope, id, {
  ...
  private _timeouts = new DataIonoscloudDataplatformVersionsTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataIonoscloudDataplatformVersionsTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataIonoscloudDataplatformVersionsTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: dataIonoscloudDataplatformVersionsTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataIonoscloudDataplatformVersionsTimeouts",
      },
    };
