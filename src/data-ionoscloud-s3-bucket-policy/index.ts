...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.9/docs/data-sources/s3_bucket_policy
...
export class DataIonoscloudS3BucketPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIonoscloudS3BucketPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.9/docs/data-sources/s3_bucket_policy#import import section} in the documentation of this resource for the id to use
