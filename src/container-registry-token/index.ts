...
// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.4/docs/resources/container_registry_token
...
export class ContainerRegistryToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerRegistryToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.5.4/docs/resources/container_registry_token#import import section} in the documentation of this resource for the id to use
